...
class Atri:
	def __init__(self, state: Any):
		...
		self.linearGrad = state["linearGrad"]
	...
	@property
	def linearGrad(self):
		self._getter_access_tracker["linearGrad"] = {}
		return self._linearGrad
	@linearGrad.setter
	def linearGrad(self, new_state):
		self._setter_access_tracker["linearGrad"] = {}
		global default_state
		self._linearGrad = TextBox(new_state, default_state["linearGrad"])
